...
% 
% History
% 14/08/2006 I made some changes suggeseted by 
% Brian Harms <brianharms@hotmail.com> and Ivan Cao-Berg <icaoberg@cmu.edu> 
% (at the user review area of Mathwork File exchage) The program should work 
...
%
% 1/11/2017
% Minor update to allow FCS3.1 data from Attune NxT to read
...
%     
    ...
    for i=1:fcshdr.NumOfPar
        ...
        fcshdr.par(i).marker = get_mnemonic_value(['$P',num2str(i),'S'],fcsheader_main, mnemonic_separator);
...
if strcmp(mnemonic_separator,'\')  || strcmp(mnemonic_separator,'!') ...
        ...
        || strcmp(mnemonic_separator, '/') || strcmp(mnemonic_separator, '*') || strcmp(mnemonic_separator, '#') || strcmp(mnemonic_separator, '$')
